...
The project is also set up to be able to take in any 16x16 tile set.  

The corresponding tile types like ground, tree, water, mountain and so on just need to be placed into the appropriate public parameters on the World Manager object in the unity editor.
